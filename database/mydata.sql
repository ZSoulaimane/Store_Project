...
INSERT INTO `categories` VALUES (1,'Pop'),(2,'Rap');
...
CREATE TABLE `clients` (
  ...
  `tel` int NOT NULL,
  `MotePasse` varchar(255) NOT NULL,
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Id` (`Id`),
...
INSERT INTO `commandes` VALUES (1,1,'2021-04-24'),(2,0,'2021-04-08'),(3,0,'2021-04-08'),(4,1,'2021-04-08'),(5,1,'2021-04-10');
...
INSERT INTO `lignecommandes` VALUES (5,1,1);
...
-- Dump completed on 2021-04-11 20:47:05
